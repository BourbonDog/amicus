...
## v4.0 — "Councils become a command you can trust" *(foundation — engine-first)*
...
## v4.1 — "The skill sheds the ritual" *(skill-on-engine fast path)*
...
## v4.2 — "Bring your own models — $0, private, offline"
