...
```js
  ...
  { id: 'K9', title: "direct anthropic haiku limit.output 40000 + variant 'max'", anthropic: { [HAIKU]: { limit: { context: HCTX, output: 40000 } } }, model: AN(HAIKU), extra: { variant: 'max' }, expect: '63999 = min(40000, 32000) + 31999 — under the ceiling, nothing clamps', want: W(63999, null, 'any') },
