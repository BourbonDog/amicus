...
// (verdict.js :: buildVerdict). The T13 round trip below drives all three
// rather than re-declaring the row shape by hand at each hop.
...
// tally's output verbatim, so verdict.json inherits the strip. Producing the row
// with the REAL buildRunStatsEntry makes T13c a genuine round trip between two
