...
| `amicus list` | Show previous sessions (`--tag`/`--search`/`--all` across projects). |
...
| `amicus_list` | List past sessions (`tag` column; `search` filters by id/tag/briefing substring). |
